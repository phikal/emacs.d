...
*** Scratch Buffer
	...
	I use the =*scratch*= buffer quite a lot, but I don't want it to be
	boring: to mitigate this serious issue, I replace the default
	message with a fortune cookie.
