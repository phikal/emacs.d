...
* Introductory comments
  This document is [[https://zge.us.to/][my]] configuration for [[https://gnu.org/s/emacs][GNU Emacs]], using [[https://org-mode.org/][Org Mode's]]
  ...
  This configuration is occasionally updated [[https://zge.us.to/emacs.d.html][on my website]], and the [[https://zge.us.to/git/.emacs.d/][Git
...
* Global Keybindings
  ...
  different (eg. =C-z= to ignore), or better (eg. =M-SPC= to cycle-spacing)
  commands.
