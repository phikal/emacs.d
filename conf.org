...
**** Go
	 #+BEGIN_SRC emacs-lisp
	   (use-package go-mode
		 :init
		 (add-hook 'go-mode-hook (locally-setq compile-command "go generate && go build -v && go test -v && go vet"))
...
**** Common Lisp
	 #+BEGIN_SRC emacs-lisp
	   ...
	   (use-package slime-company
		 :init
		 (add-hook 'slime-mode '(locally-setq company-backends '(company-slime)))
		 :config
...
**** Haskell
	 ...
	 #+BEGIN_SRC emacs-lisp
	   (use-package company-ghc
		 :after company
		 :init
		 (add-hook 'haskell-mode-hook (locally-setq company-backends '(company-ghc))))
	 #+END_SRC
