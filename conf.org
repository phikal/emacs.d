...
* Introductory comments
  ...
  how I initialise my configuration is given [[*Why use org/babel?][below]].
...
** Personal Emacs History
   ...
   personalised, etc. Ultimately, I came to the conclusion that one
   shouldn't customise Vi(m), or at the very least keep it as minimal as
   ...
   Emacs. For a while I even had issues remembering and recognising the
   ...
   1. Me having have met "real" Emacs users, and drawing my attention to
	  the Editor, making me realise that it's not just a notepad with
   ...
   frequently. I kept on reading that Org mode was great, but I didn't
...
** Inspirations for writing this configuration
   ...
   - [[http://archive.is/qw0r8][Org Mode -- Organize Your Life in Plain Text!]]
   - [[https://www.freebsd.org/doc/en/books/developers-handbook/emacs.html][Using Emacs as a Development Environment]]
   - [[https://www.dgp.toronto.edu/~ghali/emacs.html][Sheruf Ghali's Emacs config]]
   - [[https://caolan.org/dotfiles/emacs.html][Caolan McMahon's Emacs Configuration]]
   - [[https://github.com/jwiegley/dot-emacs][John Wiegley's (=use-package= creator) "dot-emacs"]]
   - [[https://tuhdo.github.io/emacs-tutor3.html][Tu Do's "Emacs Mini Manual (PART 3)"]]
   - [[https://gitlab.com/j3kyl/dots/blob/master/gnu/.emacs.d/init.el][j3kyl's =init.el=]]
   - [[https://github.com/larstvei/dot-emacs/][Lard Tveito's "dot-emacs"]]
   - [[https://github.com/hrs/dotfiles/blob/master/emacs/.emacs.d/configuration.org][Harry R. Schwarz' (hrs) "dotfiles"]]
   - [[http://pages.sachachua.com/.emacs.d/Sacha.html][Sacha Chua's Emacs configuration]]
   - [[https://github.com/codemac/config/blob/master/emacs.d/boot.org][Jeff Mickey's (codemac) Emacs]]
   - [[https://mrblog.nl/emacs/config.html][Marcel van der Boom's "Orgmode configuration"]]
   - [[http://home.thep.lu.se/~karlf/emacs.html][Karl Fogelmark's .emacs]]
   - [[https://git.sr.ht/~jakob/.emacs.d][Jakob L. Kreuze's .emacs.d]]
   - [[https://github.com/wasamasa/dotemacs/blob/master/init.org][Vasilij Schneidermann's dotemacs]]
   - [[http://chneukirchen.org/dotfiles/.emacs][Leah Neukirchen's .emacs]]
   - [[https://github.com/danielmai/.emacs.d/blob/master/config.org][Daniel Mai's .emacs.d]]
   - [[https://github.com/stsquad/my-emacs-stuff][Alex Bennée's configuration]]
   - [[https://protesilaos.com/dotemacs/][Protesilaos Stavrou's dotemacs]]
   - [[https://gitlab.com/link0ff/emacs-init/blob/master/emacs.el][Juri Linkov's emacs-init]]
   - [[https://www.markus-gattol.name/ws/.emacs.html][Markus Gattol's .emacs]]
...
** Open Mailto Links
   ...
   The shell script I have to invoke this special event is just the
   following:

   #+INCLUDE: "~/etc/bin/emacs-mailto" src sh :tangle no
