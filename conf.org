	 ...
	 #+BEGIN_SRC emacs-lisp
	   (use-package slime
		 ...
		 :custom ((common-lisp-hyperspec-root "file:///usr/share/doc/hyperspec/")
				  ...
				  (slime-contribs
				   '(slime-fancy slime-hyperdoc slime-mdot-fu slime-cl-indent)))
		 :config
		 (setq inferior-lisp-program (executable-find "sbcl"))
		 :bind (:map slime-mode-map ("C-c #" . slime-selector))
...
** Timestamp
   #+BEGIN_SRC emacs-lisp
	 ...
	 (defalias 'insert-timestamp #'zge/insert-timestamp)
   #+END_SRC
