...
**** LaTeX
	 #+BEGIN_SRC emacs-lisp
	   (use-package auctex
		 ...
		 :hook ((LaTeX-mode . (locally-setq company-backends '(company-latex-commands company-math)))
	 ...
	 #+BEGIN_SRC emacs-lisp
	   (use-package go-mode
		 ...
		 (let* ((go-path  "/home/phi/code/go")
		   ...
		   (add-to-PATH go-bin))
		 :mode (rx ".go" eos)
		 :hook ((go-mode . (locally-setq compile-command "go generate && go build -v && go test -v && go vet"))
	   ...
	   (use-package company-go
		 ...
		 :hook (go-mode . (locally-setq company-backends '(company-go))))
...
**** Common Lisp
	 #+BEGIN_SRC emacs-lisp
	   ...
	   (use-package slime-company
		 ...
		 :hook (slime-mode . (locally-setq company-backends '(company-slime))))
	 #+END_SRC
...
**** Haskell
	 ...
	 #+BEGIN_SRC emacs-lisp
	   (use-package company-ghc
		 :after company
		 :hook (haskell-mode . (locally-setq company-backends '(company-ghc))))
	 #+END_SRC
