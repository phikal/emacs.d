...
**** Per-Mode Colors
	 #+BEGIN_SRC emacs-lisp
	   (use-package face-shift
		 ...
		 :load-path "lisp/"
		 :config
		 (add-hook 'text-mode-hook (face-shift 'yellow))
		 (add-hook 'prog-mode-hook (face-shift 'green))
		 (add-hook 'dired-mode-hook (face-shift 'blue))
		 (add-hook 'eshell-mode-hook (face-shift 'peach))
		 (add-hook 'comint-mode-hook (face-shift 'peach)))
	 #+END_SRC
...
**** Browser
	 #+BEGIN_SRC emacs-lisp
	   (setq-default browse-url-browser-function
					 '(("^file:///usr/share/doc/hyperspec/" . eww-browse-url)
