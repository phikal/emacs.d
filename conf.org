...
*** Cycle Spaces
	#+BEGIN_SRC emacs-lisp
	  (advice-add 'cycle-spacing :around
				  (lambda (old arg &rest _) (funcall old (- arg))))
	#+END_SRC
...
**** Per-Mode Colors
	 #+BEGIN_SRC emacs-lisp
	   (use-package face-shift
		 ...
		 (add-hook 'eshell-mode-hook (face-shift 'pink))
		 (add-hook 'comint-mode-map (face-shift 'pink)))
	 #+END_SRC
...
**** Go
	 ...
	 #+BEGIN_SRC emacs-lisp
	   (use-package go-capf
		 ...
		 (add-hook 'go-mode-hook
				   (setl completion-at-point-functions
						 (list #'go-completion-at-point-function))))
	 #+END_SRC
