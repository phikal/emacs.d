...
***** Notification
	  #+BEGIN_SRC emacs-lisp
		(use-package dtm
		  :ensure nil
		  :defines (dtm-maildir-base-dir dtm-maildir-list)
		  :init
		  (display-time-mode)
		  (setq display-time-mail-function #'dtm-mail-function
				display-time-interval 20
				display-time-string-forms
				'("<" (format-time-string "%H:%M" now) load
				  (if mail
					  (concat
					   " "
					   (propertize display-time-mail-string
								   'help-echo (dtm-who-from)
				  ...
				  "> "))
		  :config
		  (setq dtm-maildir-base-dir "~/etc/mail/"
				dtm-maildir-list '("pers" "uni")))
	  #+END_SRC
...
**** C
	 ...
	 #+BEGIN_SRC emacs-lisp
	   (use-package cpp-capf
		 :ensure nil
		 :init
		 (capf-conf c #'cpp-completion-at-point-function))
	 #+END_SRC
...
**** Go
	 ...
	 #+BEGIN_SRC emacs-lisp
	   (use-package go-capf
		 :ensure nil
		 :init
		 (capf-conf go #'go-completion-at-point-function))
	 #+END_SRC
